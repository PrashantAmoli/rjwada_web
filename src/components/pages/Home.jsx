    ...
    <Container fluid className="home">
      <Container fluid className="heading-home">
        ...
        <h6 class="text-lg-center" className="sub-heading-1">
          Dynamic Deep tech to increase your conversion rate <br /> and lower
          the return rate on your products
        </h6>
          ...
          <Col className="container-col-1">
            <div className="sub-container-1">
              ...
              <div className="sub-2-container-1">
                <p>
                  A complete new feature for the new you. Be a model of your
                  own. Try as many clothes as you want
                </p>
      ...
      <Container fluid className="container-2">
        <Row className="container-2-row">
          <h1 className="container-2-heading">
            Lets Enter the future from here
          </h1>
          <h3 className="container-2-subheading-1">
            A world of <span className="blue-text">3D</span>,{" "}
            <span className="blue-text">AR</span> &{" "}
