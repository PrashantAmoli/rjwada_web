		...
		<Container fluid className="service">
			<Row className="shopify">
				<div>
					...
					<p>Make shopping experience easier with our augmented reality and 3D product on your shopify store.</p>
					<button>Integrate</button>
				</div>
			</Row>

			<Container className="service-info">
				<h3 className="head_services">
				...
				<Row className="justify-content-md-center">
					<Col className="div" lg={3} md={6} sm={12}>
						...
						<p>Install the rjwada app on your shopify store to enable the AR and 3D experience.</p>
					...
					<Col className="div" sm={12} md={5} lg={3}>
						...
						<p>Make an account and login to our dashboard to enjoy the AR technology</p>
			...
			<Container className="view_services">
				<Row>
					<Col sx={6}>
					...
					<Col sx={6}>
						...
						<p>
							71% of consumers say they would shop more often if they used augmented reality,
							<br />
							<br />
							With another 61% of consumers saying they prefer retailers that offer such experiences.
							<br />
							<br />
